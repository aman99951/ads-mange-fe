  ...
  return (
    <AppLayout maxWidth="max-w-4xl">
      ...
      <PageHeader
        ...
        description="Follow the steps to build your advertisement"
      />
      ...
      <div className={`rounded-2xl p-6 sm:p-8 transition-all duration-500 ${
        dark ? 'bg-neutral-900/90 backdrop-blur-xl border border-amber-500/20' : 'bg-white border border-stone-200 shadow-sm'
      }`}>
        {step === 1 && (
          ...
          <div className="space-y-5 animate-[fadeIn_0.3s_ease]">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className={`px-3 text-[10px] font-medium uppercase tracking-widest ${dark ? 'bg-black text-neutral-600' : 'bg-stone-50 text-stone-400'}`}>Or</span>
              </div>
            </div>
