...
export const ads = {
  ...
  proxyImage: (url) => request('/ads/proxy_image/', { method: 'POST', body: JSON.stringify({ url }) }),
  deleteAsset: (data) => request('/ads/delete_asset/', { method: 'DELETE', body: JSON.stringify(data) }),
